...
# Qwen4-Exp GDN uses v/k head ratio 3 (48/16). Keep ratio-3 on every
# backend, including HCU, so Flash-Next does not fall off the fused path.
_GDN_FUSED_QKVZBA_RATIOS = (
    (1, 2, 3, 4, 8) if _use_aiter else (1, 2, 3, 4)
)
