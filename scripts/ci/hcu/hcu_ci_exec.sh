...
ENV_MAP[SGLANG_TEST_DEFAULT_SMALL_EMBEDDING_MODEL_NAME]="${SGLANG_TEST_DEFAULT_SMALL_EMBEDDING_MODEL_NAME:-/ci_public/sglang-das/models/Alibaba-NLP/gte-Qwen2-1.5B-instruct}"
...
ENV_MAP[SGLANG_TEST_DEFAULT_REASONING_MODEL_NAME]="${SGLANG_TEST_DEFAULT_REASONING_MODEL_NAME:-/ci_public/sglang-das/models/deepseek-ai/DeepSeek-R1-Distill-Qwen-7B}"
